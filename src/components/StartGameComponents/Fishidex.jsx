  ...
  return (
   <div>
    <div className="flex justify-center leading-[100px]">
     <img alt="fish swimming to the side" src="/fishidex-fish-2.png" />
    ...
    <ul className="grid grid-cols-2 grid-rows-5 gap-3 mb-5">
     {allFish.map((fish) => {
      if (currentUser === "Guest") {
       return (
        <li className="flex flex-col mr-0 bg-cyan-600 rounded-lg py-7 w-96 text-white bg-opacity-60 justify-self-center" key={fish.name}>
